                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-0">
                          <table class="table table-striped">
                            <thead>
                              <tr>
                                <th class="shopnamecol">Shop Name</th>
                                <th class="">Com. Rate</th>
                                <th class="prdnamecol">Product Name</th>
                                <th class="prdpricecol">Product Price</th>
                                <th class="comamtcol">Com. Amount</th>
                                <th class="pagecol">Page</th>
                                <th >Actions</th>
                              </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr>
                                    <td class="shopnamecol"> {{  $product->shop->shopname }}
                                    ...
                                    <td class="prdpricecol"> $ {{  $product->productprice }}  </td>
                                    <td class="comamtcol"> {{  $product->commission_amount }}  </td>
                                    <td class="pagecol"> {{  $product->productmenu }}  </td>
