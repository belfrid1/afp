...
class FrontController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $products = Product::where('productmenu','menu_mainproduct')
                            ->orderBy('id', 'desc')
                            ->get();
        return view('front.landingpage', compact('gender', 'backgrounds', 'products', 'criteria'));
    }
    ...
    public function accessories()
    {
         ...
         // we rettrive here all product that will be display in front main page
         // $products = Product::where('productmenu','menu_mainproduct')->take(3)->get();
         $products = Product::where('productmenu','menu_accessory')->orderBy('id', 'desc')->limit(9)->get();
    ...
    public function toys()
    {
         ...
         // we rettrive here all product that will be display in front main page
         // $products = Product::where('productmenu','menu_mainproduct')->take(3)->get();
         $products = Product::where('productmenu','menu_toys')->orderBy('id', 'desc')->limit(9)->get();
    ...
    public function underwears()
    {
         ...
         // we rettrive here all product that will be display in front main page
         // $products = Product::where('productmenu','menu_mainproduct')->take(3)->get();
         $products = Product::where('productmenu','menu_underwear')->orderBy('id', 'desc')->limit(9)->get();
       ...
       if($arrayChoiceCheckeds == null){
            ...
            foreach ($productsCriteria as $prdCriteria) {
                foreach ($prdCriteria as $key) {
                    $prdProduct = Product::where('id',$key->product_id)->get()->first();
            ...
            // dd($arrayChoiceCheckeds,$productsIdToSort);
